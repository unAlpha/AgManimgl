...
class video_text0(Scene):
    ...
    def construct(self):
        ...
        bg_text2 = BackgroundRectangle(
            text2, fill_opacity=0.96, buff=0.168, color=BLUE_E
        )
    ...
    for i, times in enumerate(time_str, start=0):
        ...
        if os.path.exists(image_file_in):
            ...
            final_clip = concatenate_videoclips(
                [images_clip_rz, clip], method="compose"
            )
            ...
            final_video.write_videofile(
                final_video_file, codec="h264_nvenc", threads=32
            )
